...
MM_MAX_OPEN_ORDERS_PER_ACCOUNT_SYMBOL="${MM_MAX_OPEN_ORDERS_PER_ACCOUNT_SYMBOL:-60}"
...
COMMON_ENV=(
    ...
    SURPRISING_MARKET_MAKER_KAFKA_BOOTSTRAP_SERVERS="$KAFKA_BOOTSTRAP_SERVERS" \
    SURPRISING_MARKET_MAKER_KAFKA_INSTRUMENT_SNAPSHOT_GROUP_ID="surprising-market-maker-instrument-snapshot-${PRODUCT_LINE}-v1" \
    ...
    MM_MAX_OPEN_ORDERS_PER_ACCOUNT_SYMBOL="$MM_MAX_OPEN_ORDERS_PER_ACCOUNT_SYMBOL"
