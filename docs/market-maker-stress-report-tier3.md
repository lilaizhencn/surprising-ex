...
- 临时日志目录：`/tmp/surprising-mm-stress.6Z6Lu8`
...
- Kafka client ids：matching=mm-stress-1783187273125561000-matching-1-0, account=mm-stress-1783187273125561000-account-1-0,mm-stress-1783187273125561000-account-1-1
- Matching owner：symbol=BTC-USDT order.commands.partition=14 clientId=mm-stress-1783187273125561000-matching-1-0
- Matching owner：symbol=ETH-USDT order.commands.partition=17 clientId=mm-stress-1783187273125561000-matching-1-0
...
- 做市商账号数：4
- 做市商初始深度：每个 symbol、每侧 40 档，每档 50 steps
- 做市商刷新挂单：每个 symbol、每侧 12 档，每档 20 steps
- 做市商连续刷新轮数：3，轮间隔 0s
...
- 等待窗口：takerFilled=900s，tradesWritten=900s，accountSettled=1200s
...
- 普通用户 taker 订单：6000
- 撮合成交笔数：6000
- account 已结算普通用户成交：6000
- 客户端并发提交耗时：220814.306 ms
- 客户端提交吞吐：27.17 orders/s
- matching event-time 吞吐：9.26 trades/s
- WebSocket：btc_depth=3423 eth_depth=3418 private_orders=1 private_positions=1 private_user_0_orders=1 private_user_0_positions=1 private_user_1_orders=1 private_user_1_positions=1 private_user_2_orders=1 private_user_2_positions=1
...
- order accepted -> matching result：6000 2470.274 333591.006 545958.762 608541.815 628805.720
- order accepted -> account processed trade：6000 5340.551 428109.706 703097.453 761067.373 785484.749

## Account Prometheus 指标

- match-trade events：processed=6000 duplicate=0 failed=0
- processed processing：avg=0.26549s max=0.326954s eventLagAvg=93.204334s eventLagMax=223.279826s
...
- Kafka lag 采样日志：/tmp/surprising-mm-stress.6Z6Lu8/kafka-lag.log
- surprising-account-v1 / surprising.perp.match.trades.v1：maxLag=2442 lastLag=0 lastSample=2026-07-04T18:10:04Z

## PostgreSQL 指标

- PostgreSQL delta：commits=76342 rollbacks=0 inserted=116979 updated=227634 deleted=264 fetched=18729439 returned=187234821 blocksRead=6 blocksHit=24443245 hitRatio=100.0% tempFiles=0 tempBytes=0 deadlocks=0
- 表行数：orders=7216 orderEvents=7216 matchResults=7216 matchTrades=6000 processedTrades=6000 accountLedgers=6004 positions=6008 openTradingOutbox=0 openAccountOutbox=0

## Provider Prometheus 摘要

- order：httpCount=6272 httpAvg=1.707442s httpMax=0s hikariActive=0 hikariPending=0 hikariMax=60 processCpu=0 systemCpu=0 heap=108.35MiB/4096.0MiB
- matching：httpCount=0 httpAvg=n/a httpMax=n/a hikariActive=0 hikariPending=0 hikariMax=30 processCpu=0 systemCpu=0 heap=92.04MiB/4096.0MiB
- account：httpCount=6004 httpAvg=0.022472s httpMax=0s hikariActive=0 hikariPending=0 hikariMax=40 processCpu=0.034265 systemCpu=0.408499 heap=40.61MiB/4096.0MiB
- websocket：httpCount=5 httpAvg=0.025838s httpMax=0s hikariActive=n/a hikariPending=n/a hikariMax=n/a processCpu=0 systemCpu=0 heap=59.06MiB/4096.0MiB
- gateway：httpCount=0 httpAvg=n/a httpMax=n/a hikariActive=0 hikariPending=0 hikariMax=20 processCpu=0 systemCpu=0 heap=82.96MiB/4096.0MiB
...
- 客户端并发提交耗时包含 576 笔 maker 刷新挂单和 6000 笔普通用户 IOC 吃单；吞吐按普通用户 taker 订单数计算。
