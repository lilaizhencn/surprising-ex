...
- `JAVA_HOME="$(/usr/libexec/java_home -v 21)" mvn -q -pl :surprising-order-provider,:surprising-account-provider,:surprising-risk-provider,:surprising-liquidation-provider,:surprising-funding-provider,:surprising-integration-test -am test`: passed, covering leverage settings, risk-bracket-aware order margin, fee snapshots, account settlement, risk, liquidation, funding, and the Java integration chain.
