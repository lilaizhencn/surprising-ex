...
- 临时日志目录：`/tmp/surprising-mm-stress.WZBv7s`

## Provider 拓扑

- Provider nodes：matching=1, account=1, websocket=1, order=1, gateway=1
- Kafka group members：surprising-matching-v1/order.commands=2, surprising-account-v1/match.trades=2
- Kafka client ids：matching=mm-stress-1783252535807365000-matching-1-0,mm-stress-1783252535807365000-matching-1-1, account=mm-stress-1783252535807365000-account-1-1,mm-stress-1783252535807365000-account-1-0
- Matching owner：symbol=BTC-USDT order.commands.partition=14 clientId=mm-stress-1783252535807365000-matching-1-1
- Matching owner：symbol=ETH-USDT order.commands.partition=17 clientId=mm-stress-1783252535807365000-matching-1-1
...
- Consumer 并发：matching 每节点 2，account 每节点 2
...
- 客户端并发提交耗时：47280.407 ms
- 客户端提交吞吐：42.3 orders/s
- matching event-time 吞吐：9.46 trades/s
...
- order accepted -> matching result：2000 2547.151 120069.872 182645.856 197870.844 202258.322
- order accepted -> account processed trade：2000 3563.150 144775.592 225733.948 239560.292 248641.534

## Account Prometheus 指标

- match-trade events：processed=2000 duplicate=0 failed=0
- processed processing：avg=0.220769s max=0.414707s eventLagAvg=23.998579s eventLagMax=61.750162s
...
- Kafka lag 采样日志：/tmp/surprising-mm-stress.WZBv7s/kafka-lag.log
- surprising-account-v1 / surprising.perp.match.trades.v1：maxLag=785 lastLag=0 lastSample=2026-07-05T12:02:27Z

## PostgreSQL 指标

- PostgreSQL delta：commits=26736 rollbacks=0 inserted=42070 updated=78480 deleted=97 fetched=2084622 returned=43610146 blocksRead=22 blocksHit=5555703 hitRatio=100.0% tempFiles=0 tempBytes=0 deadlocks=0
...
- order：httpCount=2128 httpAvg=0.793253s httpMax=0s hikariActive=0 hikariPending=0 hikariMax=60 processCpu=0 systemCpu=0 heap=71.57MiB/4096.0MiB
- matching：httpCount=0 httpAvg=n/a httpMax=n/a hikariActive=0 hikariPending=0 hikariMax=30 processCpu=0 systemCpu=0 heap=89.11MiB/4096.0MiB
- account：httpCount=0 httpAvg=n/a httpMax=n/a hikariActive=0 hikariPending=0 hikariMax=40 processCpu=0.005663 systemCpu=0.330046 heap=77.38MiB/4096.0MiB
- websocket：httpCount=12 httpAvg=0.009752s httpMax=0s hikariActive=n/a hikariPending=n/a hikariMax=n/a processCpu=0 systemCpu=0 heap=82.36MiB/4096.0MiB
- gateway：httpCount=0 httpAvg=n/a httpMax=n/a hikariActive=0 hikariPending=0 hikariMax=30 processCpu=0 systemCpu=0 heap=81.35MiB/4096.0MiB
...
- Provider 拓扑中的 `Matching active symbol consumers` 用来判断本轮热 symbol 是否真的被分散到多个 matching consumer；本轮 `split=false`，BTC-USDT 和 ETH-USDT 都由 `matching-1-1` 承接，因此 `MATCHING_CONSUMERS_PER_NODE=2` 没有让两个热 symbol 真正并行撮合。
