...
- 临时日志目录：`/tmp/surprising-mm-stress.TpaxE8`
...
- Kafka client ids：matching=mm-stress-1783250966321182000-matching-1-0, account=mm-stress-1783250966321182000-account-1-0,mm-stress-1783250966321182000-account-1-1
- Matching owner：symbol=BTC-USDT order.commands.partition=14 clientId=mm-stress-1783250966321182000-matching-1-0
- Matching owner：symbol=ETH-USDT order.commands.partition=17 clientId=mm-stress-1783250966321182000-matching-1-0
...
- 客户端并发提交耗时：87793.329 ms
- 客户端提交吞吐：22.78 orders/s
- matching event-time 吞吐：5.86 trades/s
...
- order accepted -> matching result：2000 17825.745 224375.651 352116.361 379319.649 387260.768
- order accepted -> account processed trade：2000 19870.556 275834.479 441939.182 467933.285 485400.757

## Account Prometheus 指标

- match-trade events：processed=2000 duplicate=0 failed=0
- processed processing：avg=0.428608s max=0.626104s eventLagAvg=51.265767s eventLagMax=150.163556s
...
- Kafka lag 采样日志：/tmp/surprising-mm-stress.TpaxE8/kafka-lag.log
- surprising-account-v1 / surprising.perp.match.trades.v1：maxLag=750 lastLag=0 lastSample=2026-07-05T11:42:06Z

## PostgreSQL 指标

- PostgreSQL delta：commits=31371 rollbacks=0 inserted=42059 updated=78526 deleted=109 fetched=3457934 returned=24983399 blocksRead=22 blocksHit=4674685 hitRatio=100.0% tempFiles=0 tempBytes=0 deadlocks=0
...
- order：httpCount=2128 httpAvg=1.625089s httpMax=0s hikariActive=0 hikariPending=0 hikariMax=60 processCpu=0 systemCpu=0 heap=93.86MiB/4096.0MiB
- matching：httpCount=0 httpAvg=n/a httpMax=n/a hikariActive=1 hikariPending=0 hikariMax=30 processCpu=0 systemCpu=0 heap=94.85MiB/4096.0MiB
- account：httpCount=0 httpAvg=n/a httpMax=n/a hikariActive=0 hikariPending=0 hikariMax=40 processCpu=0.008578 systemCpu=0.473903 heap=39.39MiB/4096.0MiB
- websocket：httpCount=12 httpAvg=0.015404s httpMax=0s hikariActive=n/a hikariPending=n/a hikariMax=n/a processCpu=0 systemCpu=0 heap=90.38MiB/4096.0MiB
- gateway：httpCount=0 httpAvg=n/a httpMax=n/a hikariActive=0 hikariPending=0 hikariMax=30 processCpu=0 systemCpu=0 heap=82.28MiB/4096.0MiB
