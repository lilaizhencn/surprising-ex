...
- 临时日志目录：`/tmp/surprising-mm-stress.70mzHb`
...
- Kafka client ids：matching=mm-stress-1782951039725847000-matching-2-0,mm-stress-1782951039725847000-matching-2-1,mm-stress-1782951039725847000-matching-1-0,mm-stress-1782951039725847000-matching-1-1, account=mm-stress-1782951039725847000-account-1-0,mm-stress-1782951039725847000-account-1-1,mm-stress-1782951039725847000-account-2-0,mm-stress-1782951039725847000-account-2-1
- Matching owner：symbol=BTC-USDT order.commands.partition=14 clientId=mm-stress-1782951039725847000-matching-2-0
- Matching owner：symbol=ETH-USDT order.commands.partition=17 clientId=mm-stress-1782951039725847000-matching-2-1
- Extra WebSocket group：surprising-websocket-mm-1782951039725847000-2/depth members=2

## 故障场景

- Matching node failure after open book：stopped matching-2 owning BTC-USDT partition 14, restarted it, recovered owner clientId=mm-stress-1782951039725847000-matching-2-0, and filled a taker order against pre-failure maker liquidity.
...
- 客户端并发提交耗时：1734.976 ms
- 客户端提交吞吐：11.53 orders/s
- matching event-time 吞吐：7.88 trades/s
- WebSocket：btc_depth=51 eth_depth=50 private_orders=1 private_positions=1 extra_websocket_depth=51
...
- order accepted -> matching result：20 466.067 1316.694 2744.123 2817.025 2817.025
- order accepted -> account processed trade：20 1068.544 2947.123 4600.118 4757.907 4757.907

## Account Prometheus 指标

- match-trade events：processed=21 duplicate=0 failed=0
- processed processing：avg=0.409361s max=0.692774s eventLagAvg=1.780598s eventLagMax=2.196215s
...
- Kafka lag 采样日志：/tmp/surprising-mm-stress.70mzHb/kafka-lag.log
- surprising-account-v1 / surprising.perp.match.trades.v1：maxLag=10 lastLag=0 lastSample=2026-07-02T00:14:24Z
