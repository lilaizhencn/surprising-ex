...
- 临时日志目录：`/tmp/surprising-mm-stress.9P0uvM`
...
- Kafka client ids：matching=mm-stress-1782952022156124000-matching-1-0,mm-stress-1782952022156124000-matching-1-1, account=mm-stress-1782952022156124000-account-1-0,mm-stress-1782952022156124000-account-1-1
- Matching owner：symbol=BTC-USDT order.commands.partition=14 clientId=mm-stress-1782952022156124000-matching-1-0
- Matching owner：symbol=ETH-USDT order.commands.partition=17 clientId=mm-stress-1782952022156124000-matching-1-1
...
- 撮合成交笔数：4
- account 已结算普通用户成交：4
- 客户端并发提交耗时：1685.942 ms
- 客户端提交吞吐：2.37 orders/s
- matching event-time 吞吐：10.39 trades/s
- WebSocket：btc_depth=26 eth_depth=26 private_orders=1 private_positions=1
...
- order accepted -> matching result：4 180.455 188.733 366.507 366.507 366.507
- order accepted -> account processed trade：4 1125.501 1172.315 1277.854 1277.854 1277.854

## Account Prometheus 指标

- match-trade events：processed=4 duplicate=0 failed=0
- processed processing：avg=0.286392s max=0.34513s eventLagAvg=1.094361s eventLagMax=1.19782s
...
- Kafka lag 采样日志：/tmp/surprising-mm-stress.9P0uvM/kafka-lag.log
- surprising-account-v1 / surprising.perp.match.trades.v1：maxLag=0 lastLag=0 lastSample=2026-07-02T00:29:10Z

## PostgreSQL 指标

- PostgreSQL delta：commits=319 rollbacks=0 inserted=191 updated=404 deleted=1 fetched=7551 returned=11728 blocksRead=6 blocksHit=14277 hitRatio=99.96% tempFiles=0 tempBytes=0 deadlocks=0
- 表行数：orders=52 orderEvents=52 matchResults=52 matchTrades=4 processedTrades=4 accountLedgers=8 positions=6 openTradingOutbox=0 openAccountOutbox=0

## Provider Prometheus 摘要

- order：httpCount=52 httpAvg=0.11882s httpMax=0.344828s hikariActive=0 hikariPending=0 hikariMax=30 processCpu=0 systemCpu=0 heap=34.09MiB/4096.0MiB
- matching：httpCount=0 httpAvg=n/a httpMax=n/a hikariActive=0 hikariPending=0 hikariMax=20 processCpu=0 systemCpu=0 heap=120.47MiB/4096.0MiB
- account：httpCount=8 httpAvg=0.042745s httpMax=0.113618s hikariActive=0 hikariPending=0 hikariMax=20 processCpu=0.006862 systemCpu=0.343566 heap=55.43MiB/4096.0MiB
- websocket：httpCount=3 httpAvg=0.027982s httpMax=0.028013s hikariActive=n/a hikariPending=n/a hikariMax=n/a processCpu=0 systemCpu=0 heap=59.82MiB/4096.0MiB
- gateway：httpCount=0 httpAvg=n/a httpMax=n/a hikariActive=n/a hikariPending=n/a hikariMax=n/a processCpu=0 systemCpu=0 heap=22.67MiB/4096.0MiB
...
- 客户端并发提交耗时包含 16 笔 maker 刷新挂单和 4 笔普通用户 IOC 吃单；吞吐按普通用户 taker 订单数计算。
