...
- 临时日志目录：`/tmp/surprising-mm-stress.t5ADUA`
...
- Kafka client ids：matching=mm-stress-1783251949594669000-matching-1-0, account=mm-stress-1783251949594669000-account-1-0,mm-stress-1783251949594669000-account-1-1
- Matching owner：symbol=BTC-USDT order.commands.partition=14 clientId=mm-stress-1783251949594669000-matching-1-0
- Matching owner：symbol=ETH-USDT order.commands.partition=17 clientId=mm-stress-1783251949594669000-matching-1-0
...
- 客户端并发提交耗时：13855.308 ms
- 客户端提交吞吐：14.43 orders/s
- matching event-time 吞吐：3.68 trades/s
...
- order accepted -> matching result：200 2788.900 32824.780 52947.092 53621.623 54134.127
- order accepted -> account processed trade：200 3776.543 36058.355 58994.859 59745.146 60062.255

## Account Prometheus 指标

- match-trade events：processed=200 duplicate=0 failed=0
- processed processing：avg=0.493964s max=3.704871s eventLagAvg=5.125844s eventLagMax=16.232683s
...
- Kafka lag 采样日志：/tmp/surprising-mm-stress.t5ADUA/kafka-lag.log
- surprising-account-v1 / surprising.perp.match.trades.v1：maxLag=40 lastLag=0 lastSample=2026-07-05T11:50:16Z

## PostgreSQL 指标

- PostgreSQL delta：commits=3695 rollbacks=0 inserted=4749 updated=8147 deleted=33 fetched=257015 returned=1574804 blocksRead=22 blocksHit=482654 hitRatio=100.0% tempFiles=0 tempBytes=0 deadlocks=0
...
- order：httpCount=224 httpAvg=1.668487s httpMax=8.427586s hikariActive=0 hikariPending=0 hikariMax=40 processCpu=0 systemCpu=0 heap=71.33MiB/4096.0MiB
- matching：httpCount=0 httpAvg=n/a httpMax=n/a hikariActive=0 hikariPending=0 hikariMax=20 processCpu=0 systemCpu=0 heap=93.71MiB/4096.0MiB
- account：httpCount=0 httpAvg=n/a httpMax=n/a hikariActive=0 hikariPending=0 hikariMax=30 processCpu=0.010435 systemCpu=0.395985 heap=61.21MiB/4096.0MiB
- websocket：httpCount=5 httpAvg=0.027887s httpMax=0.064392s hikariActive=n/a hikariPending=n/a hikariMax=n/a processCpu=0 systemCpu=0 heap=45.14MiB/4096.0MiB
- gateway：httpCount=0 httpAvg=n/a httpMax=n/a hikariActive=0 hikariPending=0 hikariMax=20 processCpu=0 systemCpu=0 heap=65.53MiB/4096.0MiB
