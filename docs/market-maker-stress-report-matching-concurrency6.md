...
- 临时日志目录：`/tmp/surprising-mm-stress.70GlFy`
...
- Kafka client ids：matching=mm-stress-1783253026496281000-matching-1-2,mm-stress-1783253026496281000-matching-1-3,mm-stress-1783253026496281000-matching-1-4,mm-stress-1783253026496281000-matching-1-5,mm-stress-1783253026496281000-matching-1-0,mm-stress-1783253026496281000-matching-1-1, account=mm-stress-1783253026496281000-account-1-0,mm-stress-1783253026496281000-account-1-1
- Matching owner：symbol=BTC-USDT order.commands.partition=14 clientId=mm-stress-1783253026496281000-matching-1-3
- Matching owner：symbol=ETH-USDT order.commands.partition=17 clientId=mm-stress-1783253026496281000-matching-1-5
...
- 客户端并发提交耗时：47482.709 ms
- 客户端提交吞吐：42.12 orders/s
- matching event-time 吞吐：13.17 trades/s
...
- order accepted -> matching result：2000 1728.813 88541.509 129873.085 139562.695 144543.009
- order accepted -> account processed trade：2000 4258.682 152770.313 229766.989 245160.798 254819.644

## Account Prometheus 指标

- match-trade events：processed=2000 duplicate=0 failed=0
- processed processing：avg=0.222556s max=0.418961s eventLagAvg=59.555878s eventLagMax=110.615114s
...
- Kafka lag 采样日志：/tmp/surprising-mm-stress.70GlFy/kafka-lag.log
- surprising-account-v1 / surprising.perp.match.trades.v1：maxLag=1352 lastLag=0 lastSample=2026-07-05T12:10:44Z

## PostgreSQL 指标

- PostgreSQL delta：commits=25312 rollbacks=0 inserted=41756 updated=78065 deleted=69 fetched=3600998 returned=34398483 blocksRead=22 blocksHit=5985183 hitRatio=100.0% tempFiles=0 tempBytes=0 deadlocks=0
...
- order：httpCount=2128 httpAvg=0.828188s httpMax=0s hikariActive=0 hikariPending=0 hikariMax=60 processCpu=0 systemCpu=0 heap=82.39MiB/4096.0MiB
- matching：httpCount=0 httpAvg=n/a httpMax=n/a hikariActive=0 hikariPending=0 hikariMax=30 processCpu=0 systemCpu=0 heap=83.66MiB/4096.0MiB
- account：httpCount=0 httpAvg=n/a httpMax=n/a hikariActive=0 hikariPending=0 hikariMax=40 processCpu=0.006464 systemCpu=0.333103 heap=40.81MiB/4096.0MiB
- websocket：httpCount=12 httpAvg=0.007952s httpMax=0s hikariActive=n/a hikariPending=n/a hikariMax=n/a processCpu=0 systemCpu=0 heap=81.04MiB/4096.0MiB
- gateway：httpCount=0 httpAvg=n/a httpMax=n/a hikariActive=0 hikariPending=0 hikariMax=30 processCpu=0 systemCpu=0 heap=86.09MiB/4096.0MiB
...
- 本轮 `split=true`，BTC-USDT 和 ETH-USDT 分别由 `matching-1-3`、`matching-1-5` 承接；matching result p50 为 `88541.509ms`，低于 `MATCHING_CONSUMERS_PER_NODE=2` 但未分散热 symbol 的样本。
