...
- 无 profiler 主轮：1 fork/1 thread、warmup 2×2s、measurement 3×2s；独立 GC 轮：1 fork/1 thread、warmup 1×2s、measurement 2×2s、`-prof gc`；独立短 JFR：1 fork/1 thread、warmup 1×2s、measurement 2×2s。主轮与 profiler 数值分开，带 profiler 吞吐仅用于归因。
