...
public class InstrumentKafkaConfiguration {
    ...
    public KafkaTemplate<String, String> instrumentKafkaTemplate(
            @org.springframework.beans.factory.annotation.Qualifier("instrumentProducerFactory") ProducerFactory<String, String> instrumentProducerFactory) {
    ...
    public ConcurrentKafkaListenerContainerFactory<String, String> instrumentLifecycleKafkaListenerContainerFactory(
            @org.springframework.beans.factory.annotation.Qualifier("instrumentLifecycleConsumerFactory") ConsumerFactory<String, String> instrumentLifecycleConsumerFactory) {
