...
public class InstrumentSnapshotKafkaConfiguration {
    ...
    @Bean
    public ConsumerFactory<String, String> adlInstrumentSnapshotConsumerFactory(AdlProperties properties) {
    ...
    @Bean(name = "adlInstrumentSnapshotKafkaListenerContainerFactory")
    public ConcurrentKafkaListenerContainerFactory<String, String>
    adlInstrumentSnapshotKafkaListenerContainerFactory(
            @Qualifier("adlInstrumentSnapshotConsumerFactory") ConsumerFactory<String, String> consumerFactory) {
