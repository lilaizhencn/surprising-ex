...
public final class PrimitiveLongChangeSet extends AbstractCollection<Long> {
    ...
    public PrimitiveLongChangeSet() {
        this(8);
    }

    public PrimitiveLongChangeSet(int expectedSize) {
    ...
    public ImmutableLongArrayList toImmutableList() {
