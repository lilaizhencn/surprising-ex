...
public record MarkPriceRuntime(int symbolId, long instrumentChangeId, long markPriceTicks,
    ...
    public MarkPriceRuntime {
        if (symbolId < 0 || instrumentChangeId <= 0 || markPriceTicks <= 0
    ...
    public MarkPriceRuntime(int symbolId, long instrumentChangeId, long markPriceTicks, long priceSequence,
                            long generatedAtEpochMillis) {
        this(symbolId, instrumentChangeId, markPriceTicks, 0, 0, priceSequence, generatedAtEpochMillis);
    }
}
