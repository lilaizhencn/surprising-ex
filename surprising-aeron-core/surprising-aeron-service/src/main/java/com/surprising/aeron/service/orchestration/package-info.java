 ...
 * {@code OwnerCommandPipelineState} 保存命令阶段状态，{@code OwnerResponsePublisher} 负责响应类型选择和出口交接，
 ...
 * {@code CommandSlot} 只保存单条在途撮合命令状态。业务命令处理器位于 {@code service.command.<business>}，Matcher 工作线程和账户 Lane 变更由各自包拥有。</p>
 *
