...
readonly START_ORDER='postgres,kafka,migrations,core-node0,core-node1,core-node2,exporter,projector,instrument,price,account,command,matching,derivatives-lifecycle,gateway,maker'
