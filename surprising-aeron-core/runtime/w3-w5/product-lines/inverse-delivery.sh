...
readonly TEST_PRODUCT_LINE=INVERSE_DELIVERY
readonly FIXED_RUN_ID=w4-inverse-delivery-fixed
readonly FIXED_POSTGRES_PORT=25432
readonly FIXED_KAFKA_PORT=29092
readonly SERVICE_ORDER='postgres,kafka,migrations,core-node0,core-node1,core-node2,exporter,projector,instrument,price,account,order,matching,trigger,risk,liquidation,insurance,adl,gateway,maker'
