    ...
    enum BusinessType {
        ...
        static BusinessType classify(CoreMessageType type) {
            return switch (Objects.requireNonNull(type, "message type")) {
                ...
                case PROBE_INCREMENT, VERIFY_STATE_HASH, ADJUST_BALANCE, REGISTER_INSTRUMENT,
                        UPDATE_POSITION_MODE, ADJUST_POSITION_MARGIN,
                        ...
                        INSTRUMENT_MAINTENANCE_RESULT -> null;
            };
        }
    }
