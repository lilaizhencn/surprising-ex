...
@Configuration
public class FundingKafkaConfiguration {

    @Bean
    public ProducerFactory<String, Object> fundingProducerFactory(FundingProperties properties) {
    ...
    @Bean
    public KafkaTemplate<String, Object> fundingKafkaTemplate(
            @Qualifier("fundingProducerFactory") ProducerFactory<String, Object> fundingProducerFactory) {
        return new KafkaTemplate<>(fundingProducerFactory);
    }
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, String> fundingRateCacheKafkaListenerContainerFactory(
            @Qualifier("fundingRateCacheConsumerFactory") ConsumerFactory<String, String> consumerFactory,
    ...
    fundingInstrumentSnapshotKafkaListenerContainerFactory(
            @Qualifier("fundingInstrumentSnapshotConsumerFactory") ConsumerFactory<String, String> consumerFactory) {
