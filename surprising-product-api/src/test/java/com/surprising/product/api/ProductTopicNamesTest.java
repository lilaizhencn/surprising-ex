...
class ProductTopicNamesTest {
    ...
    void buildsProductSpecificTopicNames() {
        ...
        assertThat(linear.accountOpenInterestEventsTopic())
                .isEqualTo("surprising.linear-perp.account.open-interest.events.v1");
        ...
        assertThat(linear.orderUserCommandsTopic())
                .isEqualTo("surprising.linear-perp.order.user.commands.v1");
        assertThat(linear.orderUserCommandResultsTopic())
                .isEqualTo("surprising.linear-perp.order.user.command.results.v1");
        assertThat(linear.orderStateEventsTopic())
