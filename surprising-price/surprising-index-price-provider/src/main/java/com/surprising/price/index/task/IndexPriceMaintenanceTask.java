...
public class IndexPriceMaintenanceTask {
    ...
    private final IndexInstrumentConfigService instrumentConfigService;
    ...
    public IndexPriceMaintenanceTask(ExternalSpotConnectionService externalSpotConnectionService,
                                     ...
                                     IndexInstrumentConfigService instrumentConfigService,
    ...
    @Scheduled(fixedDelayString = "${surprising.price.index.instrument.refresh-delay-ms:30000}")
    public void refreshInstrumentConfig() {
        instrumentConfigService.refresh();
    }
