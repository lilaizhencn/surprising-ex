...
本地用于构建、功能检查和真实单成员 Aeron Cluster 验证，保留网络、Archive 日志及交易 Core；标准吞吐压测统一使用昨日约28万/s基线：256币对、G1、4个 Account Lane、1个 matching engine、64 in-flight、BUSY_SPIN、batch20、30秒预热和60秒测量。历史测试结果不能直接当作当前生产容量承诺。
