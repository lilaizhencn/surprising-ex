...
/**
 * Parses only the index-price fields needed for trigger detection.
 */
@Component
public class IndexPriceTriggerParser {

    private final ObjectMapper objectMapper;

    public IndexPriceTriggerParser(ObjectMapper objectMapper) {
    ...
    public MarkTrigger parse(String payload) {
        try {
            ...
            throw new IllegalArgumentException("invalid index price payload", ex);
        }
    }
